...
SYSTEM_NAME = "Container vulnerability checker "

#An informative description for this system (this should be fairly short, about one paragraph, and may not contain HTML)
SYSTEM_DESCRIPTION = "Check vulnerability for container "
...
PROFILES = [
    Profile(
        InputTemplate('trivy', PlainTextFormat,"Enter command ",
        ...
        #------------------------------------------------------------------------------------------------------------------------
        OutputTemplate('outputfile',PlainTextFormat,'Output of the command',
...
#
# COMMAND = WEBSERVICEDIR + "/trivy_wrapper.py $DATAFILE $STATUSFILE $OUTPUTDIRECTORY"

#Or for the shell variant:
COMMAND = WEBSERVICEDIR + "/trivy_wrapper.sh $STATUSFILE $INPUTDIRECTORY $OUTPUTDIRECTORY $PARAMETERS"
